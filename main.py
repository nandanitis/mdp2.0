...
def render_about_page():
    ...
    st.title("About Us")
    st.write("At EmoTracker, we are passionate about sentiment analysis and its potential to unlock valuable insights from text data. Sentiment analysis, also known as opinion mining, is the process of determining the emotional tone or sentiment expressed in a piece of text.")
